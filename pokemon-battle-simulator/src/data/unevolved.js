...
const unevolved = [
  { id: 3, name: "이상해꽃", type: "Grass/Poison" },
    ...
    { id: 908, name: "마스카나", type: "Grass/Dark" },
    { id: 911, name: "라우드본", type: "Fire/Ghost" },
    { id: 914, name: "웨이니발", type: "Water/Fighting" },
    { id: 916, name: "퍼퓨돈", type: "Normal" },
    { id: 918, name: "트래피더", type: "Bug" },
    { id: 920, name: "엑스레그", type: "Bug/Dark" },
    { id: 923, name: "빠르모트", type: "Electric/Fighting" },
    { id: 925, name: "파밀리쥐", type: "Normal" },
    { id: 927, name: "바우첼", type: "Fairy" },
    { id: 930, name: "올리르바", type: "Grass/Normal" },
    { id: 934, name: "콜로솔트", type: "Rock" },
    { id: 936, name: "카디나르마", type: "Fire/Psychic" },
    { id: 937, name: "파라블레이즈", type: "Fire/Ghost" },
    { id: 939, name: "찌리배리", type: "Electric" },
    { id: 941, name: "찌리비크", type: "Electric/Fighting" },
    { id: 943, name: "마피티프", type: "Dark" },
    { id: 945, name: "태깅구르", type: "Poison/Normal" },
    { id: 947, name: "공푸리", type: "Grass/Ghost" },
    { id: 949, name: "육파리", type: "Ground/Grass" },
    { id: 950, name: "절벼게", type: "Rock" },
    { id: 952, name: "스코빌런", type: "Grass/Fire" },
    { id: 954, name: "베라카스", type: "Bug/Psychic" },
    { id: 956, name: "클레스퍼트라", type: "Psychic" },
    { id: 959, name: "두드리짱", type: "Fairy/Steel" },
    { id: 961, name: "바닥트리오", type: "Water" },
    { id: 962, name: "떨구새", type: "Flying/Dark" },
    { id: 964, name: "돌핀맨", type: "Water" },
    { id: 966, name: "부르르룸", type: "Steel/Poison" },
    { id: 967, name: "모토마", type: "Dragon/Normal" },
    { id: 968, name: "꿈트렁", type: "Steel" },
    { id: 970, name: "킬라플로르", type: "Rock/Poison" },
    { id: 972, name: "묘두기", type: "Ghost" },
    { id: 973, name: "꼬이밍고", type: "Flying/Fighting" },
    { id: 975, name: "우락고래", type: "Ice" },
    { id: 976, name: "가비루사", type: "Water/Psychic" },
    { id: 977, name: "어써러셔", type: "Water" },
    { id: 978, name: "싸리용", type: "Dragon/Water" },
    { id: 979, name: "저승갓숭", type: "Fighting/Ghost" }
];
